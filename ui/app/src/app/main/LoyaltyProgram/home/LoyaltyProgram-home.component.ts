...
@Component({
  selector: 'LoyaltyProgram-home',
  templateUrl: './LoyaltyProgram-home.component.html',
  styleUrls: ['./LoyaltyProgram-home.component.scss']
})
export class LoyaltyProgramHomeComponent implements AfterViewInit {
