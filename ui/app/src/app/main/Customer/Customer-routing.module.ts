...
const routes: Routes = [
  ...
  { path: ':id', component: CustomerDetailComponent,
    ...
    path: ':customer_id/CustomerInsight', loadChildren: () => import('../CustomerInsight/CustomerInsight.module').then(m => m.CustomerInsightModule),
    data: {
        oPermission: {
    ...
    path: ':customer_id/LoyaltyProgram', loadChildren: () => import('../LoyaltyProgram/LoyaltyProgram.module').then(m => m.LoyaltyProgramModule),
    data: {
        oPermission: {
