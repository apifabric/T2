...
@Component({
  selector: 'CustomerInsight-home',
  templateUrl: './CustomerInsight-home.component.html',
  styleUrls: ['./CustomerInsight-home.component.scss']
})
export class CustomerInsightHomeComponent implements AfterViewInit {
