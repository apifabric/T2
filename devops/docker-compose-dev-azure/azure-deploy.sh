...
resourcename="customerapiiter1"  # lower case, only
resourcegroup="customerapiiter1_rg"
...
# git clone https://github.com/apilogicserver/customerapiiter1.git
# cd customerapiiter1
...
az group create --name customerapiiter1_rg --location "westus"
az appservice plan create --name myAppServicePlan --resource-group customerapiiter1_rg --sku S1 --is-linux
az container create --resource-group customerapiiter1_rg --name customerapiiter1 --image apilogicserver/customerapiiter1:latest --dns-name-label customerapiiter1 --ports 5656 --environment-variables 'VERBOSE'='True'  'APILOGICPROJECT_CLIENT_URI'='//customerapiiter1.westus.azurecontainer.io:5656'
