...
def expose_models(api, method_decorators = []): 
    ...
    api.expose_object(database.models.CustomerInsight, method_decorators= method_decorators)
    api.expose_object(database.models.LoyaltyProgram, method_decorators= method_decorators)
